export const WEDDING_DETAILS = {
  ...
  publicTransit: {
    ...
    metro:
      "أقرب محطة مترو هي (محطة العباسية / أراض المعارض) ثم استقلال مواصلات التجمع الأول.",
  ...
  invitationMessage:
    "ببالغ الفرح و السرور ، ندعوكم لحضور عقد قراننا لتشاركونا فرحتنا بهذا اليوم المبارك",
};
