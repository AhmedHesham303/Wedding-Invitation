export const WEDDING_DETAILS = {
  ...
  publicTransit: {
    ...
    metro:
      "أقرب محطة مترو هي (محطة ألف مسكن) واستقلال سيارات الجامعة الأمريكية.",
    bus: "من ألف مسكن أو موقف السلام: اركب عربية الجامعة الأمريكية وانزل عند كوبري الرحاب واأسأل عن مسجد الحسن.",
    landmark: "مسجد الحسن - بالقرب من كوبري الرحاب.",
  },
